...
namespace GoogleARCore.Examples.Common
{
    ...
    public class DetectedPlaneVisualizer : MonoBehaviour
    {
        ...
        private float fTurnOn;

        private void changeVisualityOfPlanes()
        {
            m_MeshRenderer.material.SetColor("_GridColor", new Color(MyColor.r, MyColor.g, MyColor.b, fTurnOn));
        }
        ...
        public void Update()
        {
            ...
            if (Input.GetMouseButton(0))
            {
                if (fTurnOn < 0.4f)
                {
                    fTurnOn += Time.deltaTime;
                    changeVisualityOfPlanes();
                }
            }
            else
            {
        ...
        public void Initialize(DetectedPlane plane)
        {
            ...
            MyColor = k_PlaneColors[s_PlaneCount++ % k_PlaneColors.Length];
            m_MeshRenderer.material.SetColor("_GridColor", new Color(MyColor.r, MyColor.g, MyColor.b, fTurnOn));
